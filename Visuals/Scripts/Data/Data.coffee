window.MockData = 
	...
	Posts: [{
		...
		Article:
			...
			Synopsis: "This is a website for people who live in gigantic trees. Learn about how to go from branch to branch, and where to keep your crazy screaming flying dragon thing."
	...
	},
	{
		...
		Comments: [{
			...
			User: "Jake"
			AvatarLink: "#"
			Message: "Found it. Whoever decided it'd be a fun game to kick it around with those walkers owes me a new one."
		}]
	},
	{
		Avatar: "http://placehold.it/50x50"
